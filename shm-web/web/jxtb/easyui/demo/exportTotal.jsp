...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/easyui/easyuiUtils.js"></script><!-- easyui工具类 -->
    <script>
        $(function(){
            $('#test').datagrid({
                title:'示例数据',
                ...
                toolbar:[{
                    ...
                    iconCls:'icon-save',
                    handler:function(){
                        var url = "${ctx}/export.do?method=exportTotal";
