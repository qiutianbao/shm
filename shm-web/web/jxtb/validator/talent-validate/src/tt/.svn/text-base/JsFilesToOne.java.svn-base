...
public class JsFilesToOne {
	...
	public static void main(String[] args) throws Exception {
		...
		String basePath = "./";
		talentValidateToOne_21(basePath);

		final File srcFile = new File(basePath + "/js/validate/talent-validate-all-init.js");
		final File minFile = new File(basePath + "/js/validate/talent-validate-all.js");

		try {
			setupTo("F:/work/platform-4.0.0/platform-base-app/src/main/webapp");
		...
		try {
			setupTo("F:/work/platform-4.0.0-contact/platform-base-app/src/main/webapp");
	...
	private static void setupTo(String webappPath) throws IOException {
		File jsFile = new File("./js/validate/talent-validate-all-init.js");
...
//		FileUtils.copyDirectory(imgDir, new File(new File(webappPath), "js/validate/css/img"));
		...
		//<script src='../js/validate/talent-validate-all-init.js' language='javascript'>
	}

	private static void talentValidateToOne_21(String bastPath) throws Exception {
		...
		File f = new File(bastPath + "/js/validate/talent-validate-all-init.js");
