...
<html>
	...
	<head>
		...
		<script src="../js/validate/talent-validate-all-init.js" language="javascript"></script><script src="./demo.js" language="javascript"></script>  <!-- 第一步 -->
			...
			<form name="form1" id='form1'>
				...
				<br/>
				<br/>
				<span id='usernameId'>用户名</span><input type="text" value="talent" id='username' name="username" />
				<br/>
				密码<input type="text" value="2" id='password' name="password"/>
				<br/>
				
				<input type="button" class='button' value="验证" onclick="tt.validate();"/>
				<input type="button" class='button' value="取消验证" onclick="remoteV.rm();"/>
				<input type="button" class='button' value="添加验证" onclick="remoteV.add();"/> 
