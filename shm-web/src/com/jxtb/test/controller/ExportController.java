...
import com.util.excelTools.*;
import com.util.excelTools.module.DataCount;
import com.util.excelTools.module.People;
...
public class ExportController {
     ...
     * @return
     */
    @RequestMapping(params = "method=loadRowSpanData")
    @ResponseBody
     ...
     * @throws Exception
     */
    @RequestMapping(params = "method=exportTotal")
     ...
     * @throws Exception
     */
    @RequestMapping(params = "method=exportZip")
